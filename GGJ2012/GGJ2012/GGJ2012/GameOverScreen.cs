...
namespace GGJ2012
{
    class GameOverScreen : Menu
    {
        ...
        public GameOverScreen(Game1 game, ContentManager content, string background)
            : base(game, content, background)
        {
            ...
            _GameOver = new Entity(content, "gameover");
            _GameOver.Position = new Vector2(400, 170);
            _GameOver.Animations = 1;
            _GameOver.Frames = 1;
        ...
        public override void Update(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            _GameOver.Update(gameTime, spriteBatch);


            _menuFrame.Rotation += MathHelper.ToRadians(3);

            _GameOver.Scale = (float)(1 + Math.Sin(_menuFrame.Rotation * 2) * 0.025f);
